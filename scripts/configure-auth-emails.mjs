...
const templates = [
    {
        ...
        html: layout({ eyebrow: 'Tu acceso a Academy', title: '¡Bienvenido/a a la familia Academy!', intro: 'Tu cuenta está preparada. Activa tu acceso para consultar jugadores, calendario, comunicados, documentos y todo lo relacionado con Academy.', detail: 'El enlace es personal y tiene una duración limitada. No lo compartas con otras personas.', buttonLabel: 'Activar mi acceso', buttonHref: '{{ .ConfirmationURL }}' })
    },
    {

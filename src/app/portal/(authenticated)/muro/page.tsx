...
export default async function CommunityWallPage() {
    ...
    return <div className="mx-auto max-w-3xl space-y-6 pb-8">
        ...
        <div className="flex gap-3 rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-900"><ShieldCheck className="h-5 w-5 shrink-0" /><p>Para proteger a los menores, Academy revisa las publicaciones de familias antes de hacerlas visibles a la comunidad.</p></div>
